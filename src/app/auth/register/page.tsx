        ...
        <div className="bg-white dark:bg-[#16161E] rounded-3xl shadow-soft p-8 md:p-12 border border-zinc-100 dark:border-zinc-800">
          ...
          <form onSubmit={handleRegister} className="space-y-10">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Admin Name</label>
                  <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">University Name</label>
                  <div className="relative group">
                    <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-zinc-400" />
                    <input name="universityName" type="text" required value={formData.universityName} onChange={handleChange}
                      className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 pl-12 pr-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Website</label>
                  <div className="relative group">
                    <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-zinc-400" />
                    <input name="website" type="url" required value={formData.website} onChange={handleChange}
                      className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 pl-12 pr-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Established</label>
                  <input name="established" type="number" value={formData.established} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
                    placeholder="2000" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Accreditation</label>
                  <input name="accreditation" type="text" value={formData.accreditation} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
                    placeholder="NAAC A+" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Total Students</label>
                  <input name="totalStudents" type="number" value={formData.totalStudents} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Campus Size</label>
                  <input name="campusSize" type="text" value={formData.campusSize} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
                    placeholder="100 Acres" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Alumni Count</label>
                  <input name="alumniCount" type="number" value={formData.alumniCount} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Facilities (Comma separated)</label>
                <input name="facilities" type="text" value={formData.facilities} onChange={handleChange}
                  className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Placement Rate (%)</label>
                  <input name="placementRate" type="text" value={formData.placementRate} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
                    placeholder="95%" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Avg Salary</label>
                  <input name="averageSalary" type="text" value={formData.averageSalary} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
                    placeholder="6.5 LPA" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Highest Salary</label>
                  <input name="highestSalary" type="text" value={formData.highestSalary} onChange={handleChange}
                    className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
                    placeholder="45 LPA" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider ml-1">Top Recruiters (Comma separated)</label>
                <input name="topRecruiters" type="text" value={formData.topRecruiters} onChange={handleChange}
                  className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 rounded-2xl py-4 px-4 focus:ring-2 focus:ring-brand-gold outline-none dark:text-white"
